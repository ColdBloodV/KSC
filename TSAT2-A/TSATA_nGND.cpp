...
void loop() {
  ...
  //Button 2 (prevent packet collison) 
  if(buttonValue2 == HIGH && lastButtonValue2 == LOW){

    //ensuring extra packets flush no collison
    Serial.println("Getting button ready to send...");
    flush(); 
    delay(2000); //2 second delay 
    Serial.println("\n>>> You can now press Detach button!<<<");
    flush();
